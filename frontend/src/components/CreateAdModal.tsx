...
export function CreateAdModal() {
    ...
    const handleCreateAd = async (event: FormEvent) => {
        ...
        try {
            ...
            console.log(err);
            alert('Failed when trying to create ad!');
        }
    }
            ...
            <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25'>
                ...
                <form onSubmit={(event) => handleCreateAd(event)} className='mt-8 flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Input id='name' name='name' placeholder='How they call you inside the game?' />
                    </div>

                    <div className='grid grid-cols-2 gap-6'>
                        <div className='flex flex-col gap-2'>
                            <label htmlFor='yearsPlaying'>For how many years you play?</label>
                            <Input id='yearsPlaying' name='yearsPlaying' type='number' placeholder='It is all right if ZERO' />
                        </div>
                        <div className='flex flex-col gap-2'>
